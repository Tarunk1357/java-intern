Objective
Create a simple HTML-based authentication system with 5 pages and submit the code via
GitHub repository.
Requirements
...
• "Create a New Account" link (redirects to Registration page)
...
• Display "Welcome to My Dashboard" heading
